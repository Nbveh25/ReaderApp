# ReadEra - Приложение для чтения книг

Android-приложение для управления и чтения электронных книг с поддержкой различных форматов файлов.

## 📱 Описание

ReadEra - это современное Android-приложение для чтения книг, которое позволяет пользователям:
...
## 🔥 Скриншоты с Firebase

### 📊 Firebase Analytics - События открытия экранов

![Скриншот №1](docs/screenshots/analytics_1.jpg)
![Скриншот №2](docs/screenshots/analytics_2.jpg)
![Скриншот №3](docs/screenshots/analytics_3.jpg)
![Скриншот №4](docs/screenshots/analytics_4.jpg)

### 💥 Firebase Crashlytics - Отслеживание крашей

![Скриншот №1](docs/screenshots/crashlytics_1.jpg)
![Скриншот №2](docs/screenshots/crashlytics_2.jpg)

### ⚡ Firebase Performance - Метрики производительности

![Скриншот №1](docs/screenshots/perfomance.jpg)
...
📹 **Скринкаст приложения**: [Смотреть на Yandex Disk](https://disk.yandex.ru/d/f4PcfRmIhzf2WQ)
