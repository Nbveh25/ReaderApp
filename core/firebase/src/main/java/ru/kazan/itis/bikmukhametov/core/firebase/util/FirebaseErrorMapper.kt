package ru.kazan.itis.bikmukhametov.core.firebase.util

/**
 * Маппер для преобразования кодов ошибок Firebase Authentication в понятные сообщения на русском языке.
 */
